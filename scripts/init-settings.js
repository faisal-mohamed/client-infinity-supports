...
const settings = [
  ...
  },
  {
    ...
    label: "SMTP Port",
    description:
      "The port number used to connect to the SMTP server (e.g., 587 for TLS)",
    isRequired: true,
    sortOrder: 3,
  },
  {
  ...
  },
  {
    ...
    label: "Admin Notification Email",
    description:
      "Email address where system alerts or notifications will be sent",
    isRequired: true,
    sortOrder: 5,
  },
  ...
  // Staff Form IDs
  {
    ...
    description: "Unique identifier for Employee Details form",
    isRequired: true,
    sortOrder: 12,
  },
  {
    ...
    type: "text",
    category: "form_ids",
    label: "Employee Welcome Form ID",
    description: "Unique identifier for Employee Welcome form",
    isRequired: false,
    sortOrder: 13,
  },
];
