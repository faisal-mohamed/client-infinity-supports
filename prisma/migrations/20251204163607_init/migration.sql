...
CREATE TABLE "StaffCommonField" (
    ...
    CONSTRAINT "StaffCommonField_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "StaffFormBatch" (
    "id" SERIAL NOT NULL,
    "staffId" INTEGER NOT NULL,
    ...
    CONSTRAINT "StaffFormBatch_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "StaffFormProgress" (
    "id" SERIAL NOT NULL,
    "staffId" INTEGER NOT NULL,
    "formId" INTEGER NOT NULL,
    "formVersion" INTEGER NOT NULL,
    ...
    CONSTRAINT "StaffFormProgress_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "StaffSignatureBatchForm" (
    "id" SERIAL NOT NULL,
    "batchId" INTEGER NOT NULL,
    "formSubmissionId" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "StaffSignatureBatchForm_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "StaffSubmissionNotification" (
    "id" SERIAL NOT NULL,
    ...
    CONSTRAINT "StaffSubmissionNotification_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "StaffVehicleSafetyInspection" (
    "id" SERIAL NOT NULL,
    "staffId" INTEGER NOT NULL,
    "data" JSONB NOT NULL,
    "staffSignature" TEXT,
...
-- CreateTable
CREATE TABLE "StaffFormDownload" (
    "id" SERIAL NOT NULL,
    "staffId" INTEGER NOT NULL,
    ...
    CONSTRAINT "StaffFormDownload_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "StaffCommonField_staffId_key" ON "StaffCommonField"("staffId");

-- CreateIndex
CREATE UNIQUE INDEX "StaffFormBatch_batchToken_key" ON "StaffFormBatch"("batchToken");

-- CreateIndex
CREATE UNIQUE INDEX "StaffFormAssignment_staffId_formId_formVersion_key" ON "StaffFormAssignment"("staffId", "formId", "formVersion");

-- CreateIndex
CREATE UNIQUE INDEX "StaffFormProgress_staffId_formId_formVersion_key" ON "StaffFormProgress"("staffId", "formId", "formVersion");

-- CreateIndex
CREATE UNIQUE INDEX "StaffSignatureBatchForm_batchId_formSubmissionId_key" ON "StaffSignatureBatchForm"("batchId", "formSubmissionId");

-- CreateIndex
CREATE INDEX "StaffActivityLog_staffId_adminId_idx" ON "StaffActivityLog"("staffId", "adminId");

-- CreateIndex
CREATE INDEX "StaffSubmissionNotification_adminId_isRead_idx" ON "StaffSubmissionNotification"("adminId", "isRead");

-- CreateIndex
CREATE INDEX "StaffSubmissionNotification_createdAt_idx" ON "StaffSubmissionNotification"("createdAt");
...
-- CreateIndex
CREATE UNIQUE INDEX "StaffVehicleSafetyInspection_staffId_key" ON "StaffVehicleSafetyInspection"("staffId");

-- CreateIndex
CREATE INDEX "StaffFormDownload_staffId_idx" ON "StaffFormDownload"("staffId");
...
-- AddForeignKey
ALTER TABLE "Staff" ADD CONSTRAINT "Staff_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "Admin"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "StaffFormSubmission" ADD CONSTRAINT "StaffFormSubmission_formId_fkey" FOREIGN KEY ("formId") REFERENCES "MasterForm"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffCommonField" ADD CONSTRAINT "StaffCommonField_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "Staff"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffFormBatch" ADD CONSTRAINT "StaffFormBatch_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "Staff"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffFormAssignment" ADD CONSTRAINT "StaffFormAssignment_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "Staff"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffFormAssignment" ADD CONSTRAINT "StaffFormAssignment_formId_fkey" FOREIGN KEY ("formId") REFERENCES "MasterForm"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffFormAssignment" ADD CONSTRAINT "StaffFormAssignment_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "StaffFormBatch"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffFormAssignment" ADD CONSTRAINT "StaffFormAssignment_assignedById_fkey" FOREIGN KEY ("assignedById") REFERENCES "Admin"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffFormProgress" ADD CONSTRAINT "StaffFormProgress_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "Staff"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffFormProgress" ADD CONSTRAINT "StaffFormProgress_formId_fkey" FOREIGN KEY ("formId") REFERENCES "MasterForm"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffSignatureBatchForm" ADD CONSTRAINT "StaffSignatureBatchForm_batchId_fkey" FOREIGN KEY ("batchId") REFERENCES "StaffFormBatch"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffSignatureBatchForm" ADD CONSTRAINT "StaffSignatureBatchForm_formSubmissionId_fkey" FOREIGN KEY ("formSubmissionId") REFERENCES "StaffFormSubmission"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffActivityLog" ADD CONSTRAINT "StaffActivityLog_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "Staff"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffActivityLog" ADD CONSTRAINT "StaffActivityLog_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "Admin"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffSubmissionNotification" ADD CONSTRAINT "StaffSubmissionNotification_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "Admin"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffSubmissionNotification" ADD CONSTRAINT "StaffSubmissionNotification_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "Staff"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffSubmissionNotification" ADD CONSTRAINT "StaffSubmissionNotification_formSubmissionId_fkey" FOREIGN KEY ("formSubmissionId") REFERENCES "StaffFormSubmission"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "StaffVehicleSafetyInspection" ADD CONSTRAINT "StaffVehicleSafetyInspection_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "Staff"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StaffFormDownload" ADD CONSTRAINT "StaffFormDownload_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "Staff"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
