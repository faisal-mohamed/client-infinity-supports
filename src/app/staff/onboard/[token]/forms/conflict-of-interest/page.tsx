      ...
      <div className="w-full max-w-7xl mx-auto px-2 md:px-6">
        ...
        <div className="bg-white rounded-lg shadow-soft p-4 md:p-6 mb-4 md:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-azure-700">Conflict of Interest Disclosure Form</h1>
        ...
        <div className="bg-white rounded-lg shadow-soft p-2 md:p-6">
          ...
          {validationErrors.length > 0 && (
            <div className="mt-4 p-4 bg-gold-50 border-2 border-gold-300 rounded-lg">
              <h3 className="text-sm font-semibold text-gold-900 mb-2">
                ⚠️ Missing Required Fields:
              </h3>
              <ul className="list-disc list-inside text-sm text-gold-800 space-y-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6 md:mt-8 pt-4 md:pt-6 border-t">
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-3 bg-azure-500 text-white rounded-lg hover:bg-azure-700 disabled:opacity-50 disabled:cursor-not-allowed w-full sm:w-auto"
            >
