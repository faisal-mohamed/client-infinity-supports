...
export default function FairWorkInformationFormPage() {
  ...
  return (
    <div className="min-h-screen bg-azure-100 py-4 md:py-8">
      <style jsx>{`
        .view-component-wrapper .text-azure-600 {
          color: #374151 !important;
        }
        .view-component-wrapper .text-azure-400 {
          color: #4b5563 !important;
        }
        .view-component-wrapper .text-azure-700 {
      ...
      <div className="w-full max-w-7xl mx-auto px-2 md:px-6">
        <div className="bg-white rounded-lg shadow-soft p-4 md:p-6 mb-4 md:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-azure-700">
