    ...
    return (
      <div className=" flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-azure-700 mb-4">Error Loading Form</h2>
          <p className="text-azure-400 mb-6">{error}</p>
          <button
            onClick={() => window.location.reload()}
            className="px-6 py-3 bg-azure-700 text-white rounded-lg hover:bg-azure-700 transition-colors"
          >
            Try Again
          </button>
        </div>
