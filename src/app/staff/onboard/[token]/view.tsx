...
export default function OnboardClient() {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center"><div className="text-center"><div className="text-lg font-semibold">Loading Staff Forms</div><div className="text-azure-400 mt-2">Please wait...</div></div></div>;
  ...
  return (
    <div className="">
      <div className="max-w-5xl mx-auto p-6">
        ...
        <p className="text-azure-400 mb-6">Please complete your employment details below.</p>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button className="px-6 py-3 bg-azure-700 text-white rounded-lg" onClick={() => handleSubmit(true)}>Submit</button>
        </div>
      </div>
    </div>
  );
