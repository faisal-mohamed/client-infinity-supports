...
const SupportWorkerForm = forwardRef<SupportWorkerFormRef, SupportWorkerFormProps>(({ token, onValidityChange, isSignatureLink = false }, ref) => {
  ...
  return (
    <div className="bg-azure-100 py-8">
            ...
            <div className="border border-azure-300 rounded-lg p-3 sm:p-6 w-full">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                    <ul className="list-disc list-inside space-y-2 text-azure-700">
                ...
                <div>
                  ...
                  <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                    <div className="space-y-4 text-azure-700">
          ...
          <div className="w-full">
            <div className="border border-azure-300 rounded-lg p-3 sm:p-6 w-full">
              <div className="space-y-4">
                ...
                <div>
                  <div className="border border-azure-300 rounded-lg p-4 w-full">
                    <ul className="list-disc list-inside space-y-2 text-azure-700">
                ...
                <div>
                  <div className="border border-azure-300 rounded-lg p-4 w-full">
                    <p className="text-azure-700 mb-4">Infinity Supports WA Support Workers may be asked to provide support in the following areas:</p>
                    <ul className="list-disc list-inside space-y-2 text-azure-700">
          ...
          <div className="w-full">
            <div className="border border-azure-300 rounded-lg p-3 sm:p-6 w-full">
              <div className="space-y-4">
                ...
                <div>
                  <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                    <h3 className="text-lg sm:text-xl font-semibold">Workplace Health & Safety</h3>
                  </div>
                  <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                    <p className="text-azure-700 mb-4">As an employee you are required to:</p>
                    <ul className="list-disc list-inside space-y-2 text-azure-700">
                    ...
                    <div className="mt-6">
                      <h4 className="font-semibold text-azure-700 mb-2">Assessing risk:</h4>
                      <p className="text-azure-700 mb-3">Support Workers must assess risk in determining whether tasks, activities or duties are beyond the scope that could reasonably be expected from someone in the role of a Support Worker.</p>
                      <p className="text-azure-700 mb-2">Examples of tasks, duties, or activities outside the remit of a Support Worker include:</p>
                      <ul className="list-disc list-inside space-y-2 text-azure-700 ml-4">
                ...
                <div>
                  <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                    <h3 className="text-lg sm:text-xl font-semibold">Quality & Environmental Aspects</h3>
                  </div>
                  <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                    <p className="text-azure-700 mb-4">As an employee you are required to:</p>
                    <ul className="list-disc list-inside space-y-2 text-azure-700">
          ...
          <div className="w-full">
            <div className="border border-azure-300 rounded-lg p-3 sm:p-6 w-full">
              <div className="space-y-4">
                ...
                <div>
                  <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                    <h3 className="text-lg sm:text-xl font-semibold">Experience, Qualifications and Skills</h3>
                  </div>
                  <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                    <ul className="list-disc list-inside space-y-2 text-azure-700">
                ...
                <div>
                  <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                    <h3 className="text-lg sm:text-xl font-semibold">Key Requirements & Attributes</h3>
                  </div>
                  <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                    <ul className="list-disc list-inside space-y-2 text-azure-700">
                ...
                <div>
                  ...
                  <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                    <div className="space-y-4">
                      <div>
                        <label className="block text-sm font-medium text-azure-600 mb-2">Name:</label>
                        <div className="border border-azure-400 h-8 rounded-sm px-2 flex items-center text-azure-700 bg-white">
                          {staffInfo.firstName} {staffInfo.surname}
                        </div>
                      </div>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                          <label className="block text-sm font-medium text-azure-600 mb-3">Signature:</label>
                          <SignatureCanvas
                            ...
                            width={400}
                            height={120}
                            className="bg-white border border-azure-400 rounded-sm"
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-azure-600 mb-3" htmlFor="signatureDate">Date:</label>
                          <input
                            id="signatureDate"
                            type="date"
                            value={data.signatureDate || ''}
                            onChange={(e) => handleChange('signatureDate', e.target.value)}
                            className="w-full border border-azure-400 h-8 rounded-sm px-2 text-azure-700 bg-white"
                          />
                        </div>
                      </div>
                    </div>
...
function Field({ label, value }: { label: string; value?: React.ReactNode }) {
  return (
    <div>
      <div className="text-xs font-medium text-azure-600 mb-1">{label}:</div>
      <div className="border border-azure-400 h-8 rounded-sm px-2 flex items-center text-azure-700 bg-white">
        {value || ''}
      </div>
    </div>
