        ...
        <div className="text-center mb-8">
          <div className="flex justify-center items-center gap-4 mb-4">
            ...
            <div className="text-left">
              <h1 className="text-3xl font-bold text-gray-900">Infinity Supports WA</h1>
              <p className="text-sm text-gray-600 uppercase tracking-wider">Achieving Goals and Beyond</p>
            </div>
          </div>
          <h2 className="text-4xl font-bold text-gray-900">Position Description</h2>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Employee Signature:</label>
                                 <div ref={sigWrapRef} className="border border-gray-300 rounded-md">
                   <SignatureCanvas
                     width={sigWidth}
                     height={120}
