        ...
        <FormPage showTitle={false} meta={{ website: '', version: '', reviewDate: '' }}>
          <div className="space-y-4 text-sm w-full">
            <div className="w-full">
              <div className="border border-azure-300 rounded-lg p-3 sm:p-6 w-full">
                <div className="space-y-6">
                  {/* Applicant Details */}
                  <div>
                    <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                      <h3 className="text-lg sm:text-xl font-semibold">Applicant Details</h3>
                    </div>
                    <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                  ...
                  <div>
                    <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                      <h3 className="text-lg sm:text-xl font-semibold">Informed Consent (to be completed by the applicant)</h3>
                    </div>
                    <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                      <div className="space-y-3 text-azure-700 text-sm leading-relaxed mb-4">
                        <p>
                      ...
                      <div className="mt-4">
                        <div className="overflow-x-auto -mx-3 px-3">
                          <table className="w-full border-collapse border border-azure-400 min-w-[500px] sm:min-w-0">
                            <tbody>
                              {[
                                {
                                ...
                                return (
                                  <tr key={index} className={`border-b border-azure-300 ${fieldHasError ? 'bg-red-50' : ''}`}>
                                    <td className={`border px-3 py-2 text-sm text-azure-700 align-top ${fieldHasError ? 'border-red-500 border-2' : 'border-azure-400'}`} style={{ width: '70%' }}>
                                      <span className="text-red-500 mr-1">*</span>{item.label}
                                    </td>
                                    <td className={`border px-3 py-2 text-center align-top ${fieldHasError ? 'border-red-500 border-2' : 'border-azure-400'}`} style={{ width: '15%' }}>
                                      <label className="flex items-center justify-center gap-2 cursor-pointer">
                              <input
                                type="checkbox"
                                        checked={data[item.key] === true}
                                        onChange={() => handleChange(item.key, true)}
                                className="w-4 h-4 x-mark border-azure-300 rounded focus:ring-gold-500"
                                        title={`${item.label} - Yes`}
                              />
                                      <span className="text-sm text-azure-600">Yes</span>
                            </label>
                                    </td>
                                    <td className={`border px-3 py-2 text-center align-top ${fieldHasError ? 'border-red-500 border-2' : 'border-azure-400'}`} style={{ width: '15%' }}>
                                      <label className="flex items-center justify-center gap-2 cursor-pointer">
                              <input
                                ...
                                className="w-4 h-4 x-mark border-azure-300 rounded focus:ring-gold-500"
                                        title={`${item.label} - No`}
                              />
                                      <span className="text-sm text-azure-600">No</span>
                            </label>
                                    </td>
                                  </tr>
                                );
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                          <div>
                            ...
                            <SignatureCanvas
                              ...
                              width={400}
                              height={120}
                              className={`bg-white border rounded-sm ${hasError('signature') ? 'border-red-500 border-2' : 'border-azure-400'}`}
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-azure-600 mb-2">
                            ...
                            <input
                              ...
                              className={`w-full border h-8 rounded-sm px-2 text-azure-700 bg-white ${hasError('signatureDate') ? 'border-red-500 border-2' : 'border-azure-400'}`}
                            />
                          </div>
                        </div>
                      </div>
            ...
            <div className="w-full">
              <div className="border border-azure-300 rounded-lg p-3 sm:p-6 w-full">
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                      <h3 className="text-lg sm:text-xl font-semibold">Pre-Existing Injury or Disease Disclosure Statement (to be completed by the applicant)</h3>
                    </div>
                    <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                      <div className="space-y-3 text-azure-700 text-sm leading-relaxed">
                        <p>
                      ...
                      <div className="mt-4">
                        ...
                        <textarea
                          ...
                          rows={8}
                          className="w-full border border-azure-400 rounded-sm px-3 py-2 text-azure-700 bg-white"
                  ...
                  <div>
                    <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                      <h3 className="text-lg sm:text-xl font-semibold">Disclosure Advice (to be completed by the applicant)</h3>
                </div>
                    <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                      <div className="space-y-4">
                        <p className="text-azure-700 text-sm leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div>
                            ...
                            <SignatureCanvas
                              ...
                              width={400}
                              height={120}
                              className={`bg-white border rounded-sm ${hasError('disclosureAdviceSignature') ? 'border-red-500 border-2' : 'border-azure-400'}`}
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-azure-600 mb-2">
                            ...
                            <input
                              ...
                              className={`w-full border h-8 rounded-sm px-2 text-azure-700 bg-white ${hasError('disclosureAdviceDate') ? 'border-red-500 border-2' : 'border-azure-400'}`}
                            />
                          </div>
                        </div>
                      </div>
            ...
            <div className="w-full">
              <div className="border border-azure-300 rounded-lg p-3 sm:p-6 w-full">
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                      <h3 className="text-lg sm:text-xl font-semibold">General Health Questionnaire (to be completed by the applicant)</h3>
                    </div>
                    <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-azure-400">
                          <thead>
                            <tr className="bg-azure-100">
                              <th className="border border-azure-400 px-3 py-2 text-left text-sm font-medium text-azure-600">Question</th>
                              <th className="border border-azure-400 px-3 py-2 text-center text-sm font-medium text-azure-600">Yes</th>
                              <th className="border border-azure-400 px-3 py-2 text-center text-sm font-medium text-azure-600">No</th>
                              <th className="border border-azure-400 px-3 py-2 text-center text-sm font-medium text-azure-600">Details</th>
                            </tr>
                          </thead>
                          <tbody>
                            ...
                            {[
                              ...
                              return (
                                <tr key={index} className={fieldHasError ? 'bg-red-50' : ''}>
                                  <td className={`border px-3 py-2 text-sm text-azure-700 ${fieldHasError ? 'border-red-500 border-2' : 'border-azure-400'}`}>
                                    <span className="text-red-500 mr-1">*</span>{question}
                                  </td>
                                  <td className={`border px-3 py-2 text-center ${fieldHasError ? 'border-red-500 border-2' : 'border-azure-400'}`}>
                                    <input
                                      type="checkbox"
                                  ...
                                  <td className={`border px-3 py-2 ${fieldHasError ? 'border-red-500 border-2' : 'border-azure-400'}`}>
                                    {data[key] === true && (
                                      <textarea
                                        value={data[`${key}Details`] || ''}
                                        onChange={(e) => handleChange(`${key}Details`, e.target.value)}
                                        rows={2}
                                        className="w-full border border-azure-400 rounded-sm px-2 py-1 text-azure-700 bg-white text-xs"
                                        placeholder="Details..."
                                      />
                                    )}
                                  </td>
                            ...
                            <tr>
                              <td colSpan={4} className="border border-azure-400 px-3 py-2 text-sm font-bold text-azure-700 bg-azure-50">
                  ...
                  <div>
                    <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                      <h3 className="text-lg sm:text-xl font-semibold">Medical History - Workplace (to be completed by the applicant)</h3>
                    </div>
                    <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-azure-400">
                          ...
                          <tbody>
                            {[
                              ...
                              return (
                                ...
                                <td className={`border px-3 py-2 text-sm text-azure-700 ${questionHasError ? 'border-red-500 border-2' : 'border-azure-400'}`}>
                                  <span className="text-red-500 mr-1">*</span>{item.question}
                                </td>
                                  <td className={`border px-3 py-2 text-center ${questionHasError ? 'border-red-500 border-2' : 'border-azure-400'}`}>
                                    <input
                                      type="checkbox"
                                    checked={data[item.key] === true}
                                    onChange={() => handleChange(item.key, true)}
                                  ...
                                  <td className={`border px-3 py-2 ${detailsHasError ? 'border-red-500 border-2' : 'border-azure-400'}`}>
                                  {data[item.key] === true && (
                                      <div>
                                      <textarea
                                        value={data[`${item.key}Details`] || ''}
                                        onChange={(e) => handleChange(`${item.key}Details`, e.target.value)}
                                        rows={2}
                                        className={`w-full border rounded-sm px-2 py-1 text-azure-700 bg-white text-xs ${detailsHasError ? 'border-red-500 border-2' : 'border-azure-400'}`}
                  ...
                  <div>
                    <div className="bg-azure-700 text-white px-4 sm:px-6 py-3 rounded-t-lg">
                      <h3 className="text-lg sm:text-xl font-semibold">Declaration (to be completed by the applicant)</h3>
                    </div>
                    <div className="border border-azure-300 rounded-b-lg p-3 sm:p-4 w-full mt-3">
                      <div className="space-y-4">
                        <p className="text-azure-700 text-sm leading-relaxed">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div>
                            ...
                            <SignatureCanvas
                              ...
                              width={400}
                              height={120}
                              className={`bg-white border rounded-sm ${hasError('declarationSignature') ? 'border-red-500 border-2' : 'border-azure-400'}`}
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-azure-600 mb-2">
                            ...
                            <input
                              ...
                              className={`w-full border h-8 rounded-sm px-2 text-azure-700 bg-white ${hasError('declarationDate') ? 'border-red-500 border-2' : 'border-azure-400'}`}
                            />
                          </div>
                        </div>
                      </div>
  ...
  return (
    <div>
      ...
      <input
        ...
        className={`w-full border h-8 rounded-sm px-2 text-azure-700 bg-white ${hasError ? 'border-red-500 border-2' : 'border-azure-400'}`}
        required={required}
      />
    </div>
  );
...
function ConsentCheckbox({ label, value, onChange }: { label: string; value: boolean | null; onChange: (v: boolean | null) => void }) {
  return (
    <div className="flex items-start gap-4">
      ...
      <span className="text-sm text-azure-700 flex-1">{label}</span>
    </div>
  );
}
