  ...
  return (
    <div className="relative" style={{ minHeight: '800px', paddingBottom: '100px' }}>
      ...
      <div className="space-y-6 text-sm">
        <p className="text-azure-600 leading-relaxed">
        ...
        <div className="bg-azure-50 border border-azure-200 rounded-lg p-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-azure-600 ml-4">
        ...
        <div className="flex items-start gap-3">
          <input
            ...
            className="mt-1 w-5 h-5 rounded border-azure-300 focus:ring-gold-500 focus:ring-2 cursor-pointer x-mark"
          />
          <label htmlFor="readAcknowledgement" className="text-azure-600 cursor-pointer">
        ...
        <div>
          ...
          <input
            ...
            className="w-full border-b border-azure-400 px-2 py-2 focus:outline-none focus:border-azure-500"
        ...
        <div>
          ...
          <div className="border-2 border-azure-300 rounded-lg p-4 bg-white">
            <SignatureCanvas
              ref={sigRef}
