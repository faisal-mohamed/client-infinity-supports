...
export default function StaffSignaturePortalClient() {
  ...
  if (loading) {
    return (
      <div className="bg-azure-50 to-azure-100 min-h-screen flex items-center justify-center px-4">
        <div className="text-center">
          <div className="w-16 h-16 sm:w-20 sm:h-20 border-4 border-t-indigo-500 border-azure-200 rounded-full animate-spin mx-auto mb-3 sm:mb-6"></div>
          <h3 className="text-lg sm:text-xl font-bold text-azure-700 mb-2">Loading Forms</h3>
          <p className="text-sm sm:text-base text-azure-400 font-medium">Please wait...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="">
        <div className="flex justify-center items-center min-h-screen px-4">
          <div className="max-w-md mx-auto text-center bg-white rounded-xl sm:rounded-2xl shadow-soft p-6 sm:p-8">
            ...
            <p className="text-sm sm:text-base text-azure-400 mb-4 sm:mb-6 leading-relaxed">{error}</p>
            <button
              onClick={() => window.location.reload()}
              className="w-full bg-azure-600 to-azure-700 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-medium hover:from-azure-700 hover:to-azure-700 transition-all duration-200 shadow-soft  text-sm sm:text-base"
            >
              Try Again
            </button>
          </div>
  ...
  if (!batchData) {
    return (
      <div className=" flex justify-center items-center">
        <div className="text-center">
          <p className="text-azure-400">No signature forms found.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        {/* Header */}
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-soft overflow-hidden mb-6 sm:mb-8">
          {/* Header Gradient */}
          ...
          {/* Staff Info Section */}
          <div className="px-4 sm:px-8 py-4 sm:py-6 bg-azure-50 to-white">
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 text-azure-600">
              <div className="flex items-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-azure-100 rounded-full flex items-center justify-center mr-3">
                  <FaUser className="h-4 w-4 sm:h-5 sm:w-5 text-azure-600" />
                </div>
                <div className="text-center sm:text-left">
                  <p className="font-semibold text-azure-700 text-sm sm:text-base">{batchData.staff.name}</p>
                  <p className="text-xs sm:text-sm text-azure-400">{batchData.staff.email}</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gold-100 rounded-full flex items-center justify-center mr-3">
                  <FaCalendarAlt className="h-4 w-4 sm:h-5 sm:w-5 text-gold-600" />
                </div>
                <div className="text-center sm:text-left">
                  <p className="font-semibold text-azure-700 text-sm sm:text-base">Expires</p>
                  <p className="text-xs sm:text-sm text-azure-400">
          ...
          <div className="px-4 sm:px-8 py-4 sm:py-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
              <div className="bg-azure-50 to-azure-50 rounded-lg sm:rounded-xl p-4 sm:p-6 text-center border border-azure-100">
              ...
              <div className="bg-gold-50 to-gold-50 rounded-lg sm:rounded-xl p-4 sm:p-6 text-center border border-gold-100">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gold-500 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
                  <FaSignature className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                </div>
                <div className="text-2xl sm:text-3xl font-bold text-gold-600 mb-1">
                  {completionStatus.formsRequiringSignature}
                </div>
                <div className="text-xs sm:text-sm font-medium text-gold-700">
                  Require Signature
                </div>
              </div>
              
              <div className="bg-emerald-50 to-emerald-50 rounded-lg sm:rounded-xl p-4 sm:p-6 text-center border border-emerald-100">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-500 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
            ...
            {(completionStatus.formsRequiringSignature > 0 || completionStatus.formsNotRequiringSignature > 0) && (
              <div className="bg-azure-50 rounded-lg sm:rounded-xl p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 space-y-1 sm:space-y-0">
                  <h3 className="text-base sm:text-lg font-semibold text-azure-700">
                  ...
                  <div 
                    className={`h-2 sm:h-3 rounded-full transition-all duration-500 ease-out ${
                      completionStatus.isComplete 
                        ? 'bg-emerald-600 to-emerald-500' 
                        : 'bg-azure-600 to-azure-600'
                    }`}
                    style={{ 
                      width: `${(() => {
          ...
          {completionStatus.isComplete && (
            <div className="mx-4 sm:mx-8 mb-4 sm:mb-6">
              <div className="bg-emerald-50 to-emerald-50 border-2 border-green-200 rounded-lg sm:rounded-xl p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-500 rounded-full flex items-center justify-center mr-0 sm:mr-4 mx-auto sm:mx-0">
                    <FaCheckCircle className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                  </div>
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-soft overflow-hidden">
          <div className="bg-azure-50 to-white px-4 sm:px-8 py-4 sm:py-6 border-b border-azure-200">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-azure-700 mb-1 sm:mb-2">
                  Forms to Complete
                </h2>
                <p className="text-sm sm:text-base text-azure-400">
          ...
          <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
            {batchData.signatureForms.map((form) => {
              ...
              return (
                <div key={form.id} className="bg-azure-50 to-white rounded-lg sm:rounded-xl border border-azure-200 hover:border-azure-300  transition-all duration-200 overflow-hidden">
                  <div className="p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
                      <div className="flex items-start sm:items-center flex-1 w-full sm:w-auto">
                        <div className="flex-shrink-0">
                          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-azure-600 to-azure-700 rounded-lg sm:rounded-xl flex items-center justify-center shadow-soft">
                      ...
                      <div className="flex-shrink-0 w-full sm:w-auto sm:ml-6 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                        ...
                        {(statusInfo.status === 'Signed' || statusInfo.status === 'Completed') && (
                          <button
                            ...
                            className={`inline-flex items-center justify-center px-4 py-2.5 border-2 text-sm font-medium rounded-lg sm:rounded-xl transition-all duration-200 shadow-sm  disabled:opacity-50 disabled:cursor-not-allowed ${
                              editingFormId === form.id
                                ? 'border-amber-400 text-gold-700 bg-amber-50 hover:bg-amber-100'
                                : 'border-azure-300 text-azure-600 bg-white hover:bg-azure-50 hover:border-azure-400'
                            } focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-azure-500`}
                            title="Edit Form"
                          >
                            {editingFormId === form.id ? (
                              <>
                        ...
                        <button
                          ...
                          className={`inline-flex items-center justify-center px-4 sm:px-6 py-2.5 border-2 border-transparent text-sm font-medium rounded-lg sm:rounded-xl transition-all duration-200 shadow-soft  focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${
                            navigatingFormId === form.id
                              ? (statusInfo.status === 'Signed' || statusInfo.status === 'Completed')
                                ? 'text-emerald-700 bg-azure-700 to-emerald-100 border-green-300'
                                : 'text-white bg-azure-400 to-azure-600 border-azure-300'
                              : (statusInfo.status === 'Signed' || statusInfo.status === 'Completed')
                                ? 'text-emerald-700 bg-azure-700 to-emerald-100 hover:from-green-200 hover:to-emerald-200 focus:ring-green-500'
                                : requiresSignature
                                ? 'text-white bg-azure-600 to-azure-700 hover:from-azure-700 hover:to-azure-700 focus:ring-gold-500'
                              : 'text-azure-700 bg-azure-100 to-azure-100 hover:from-azure-200 hover:to-azure-200 focus:ring-gold-500'
                          }`}
                        >
                          {navigatingFormId === form.id ? (
                            <>
        ...
        {/* Footer */}
        <div className="mt-6 sm:mt-8 bg-white rounded-xl sm:rounded-2xl shadow-soft p-6 sm:p-8">
          <div className="text-center">
            <div className="flex justify-center items-center mb-3 sm:mb-4">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-green-100 rounded-full flex items-center justify-center mr-2 sm:mr-3">
                <FaShieldAlt className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-600" />
              </div>
            </div>
            <p className="text-sm sm:text-base text-azure-400 mb-4 sm:mb-6 max-w-2xl mx-auto leading-relaxed px-2">
            ...
            <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6 sm:p-8">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gold-100 rounded-full flex items-center justify-center mr-4">
                  <FaExclamationCircle className="h-6 w-6 text-gold-600" />
                </div>
                <h3 className="text-xl font-bold text-azure-700">Edit Signed Form</h3>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-2 text-azure-400 mb-4">
                ...
                <p className="text-sm font-semibold text-azure-700">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 border-2 border-azure-300 text-azure-600 font-medium rounded-lg hover:bg-azure-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={confirmingEdit}
                  className="flex-1 px-4 py-2.5 bg-amber-500 to-gold-600 text-white font-medium rounded-lg hover:from-amber-600 hover:to-gold-700 transition-all shadow-soft  disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {confirmingEdit ? (
                    <>
