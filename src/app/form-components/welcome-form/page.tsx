...
const WelcomeForm = ({formData, commonFieldsData, settings} : any ) => {
  return (
    <div>
        ...
        <Page3 settings={settings}/>
        <Page4 settings={settings}/>
        <Page5 settings={settings}/>
        <Page6 settings={settings}/>
        <Page7 settings={settings}/>
        <Page8 settings={settings}/>
        <Page9 settings={settings}/>
        <Page10 settings={settings}/>
        <Page11 settings={settings}/>
        <Page12 settings={settings}/>
        <Page13 settings={settings}/>
        <Page14 settings={settings}/>
        <Page15 settings={settings}/>
        <Page16 settings={settings}/>
        <Page17 settings={settings}/>
        <Page18 settings={settings}/>
        <Page19 settings={settings}/>
        <Page20 settings={settings}/>
        <Page21 settings={settings}/>
        <Page22 settings={settings}/>
        <Page23 settings={settings}/>
        <Page24 settings={settings}/>
        <Page25 settings={settings}/>
        <Page26 schema={formSchema}  data={formData} settings={settings} commonFieldsData={commonFieldsData} />
    </div>
  )
}
