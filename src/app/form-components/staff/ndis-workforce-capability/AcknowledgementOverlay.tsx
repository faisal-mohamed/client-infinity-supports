    ...
    <>
      ...
      <div
        className={`absolute border-none border-b-2 border-gray-900 bg-transparent px-1 py-0 ${
          readOnly ? 'cursor-not-allowed opacity-70' : 'cursor-pointer hover:border-gold-500'
        }`}
        style={{ 
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl w-[600px] max-w-[90vw]">
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              <button
                onClick={handleSave}
                className="px-4 py-2 bg-azure-600 text-white rounded hover:bg-azure-700"
              >
                Save Signature
              </button>
            </div>
    ...
    <>
      ...
      <div
        className={`absolute border-2 border-gray-800 bg-white flex items-center justify-center ${
          readOnly ? 'cursor-not-allowed opacity-80' : 'cursor-pointer hover:border-gold-500'
        }`}
        style={{ 
          top, 
          left, 
