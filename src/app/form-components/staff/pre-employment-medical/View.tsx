      ...
      <FormPage showTitle={false} meta={meta}>
        <div className="space-y-4 text-sm w-full">
          <div className="w-full">
            <div className="border border-azure-100 rounded-lg p-6 w-full">
              <div className="space-y-6">
                {/* Applicant Details */}
                <div>
                  <div className="bg-azure-700 text-white px-6 py-3 rounded-t-lg">
                    <h3 className="text-xl font-semibold">Pre-Employment Medical Examination Consent Form</h3>
                  </div>
                  <div className="border border-azure-100 rounded-b-lg p-4 w-full mt-3">
                    <div className="overflow-x-auto">
                      <table className="w-full border-collapse border border-azure-200">
                        <tbody>
                          <tr>
                            <td className="border border-azure-200 px-3 py-2 text-sm font-medium text-gray-700 w-1/2">Full Name</td>
                            <td className="border border-azure-200 px-3 py-2 text-sm text-gray-900 w-1/2">
                              {data.fullName || `${staffInfo.firstName || ''} ${staffInfo.surname || ''}`.trim() || ''}
                            </td>
                          </tr>
                          <tr>
                            <td className="border border-azure-200 px-3 py-2 text-sm font-medium text-gray-700 w-1/2">Address</td>
                            <td className="border border-azure-200 px-3 py-2 text-sm text-gray-900 w-1/2">
                              {data.address || ''}
                            </td>
                          </tr>
                          <tr>
                            <td className="border border-azure-200 px-3 py-2 text-sm font-medium text-gray-700 w-1/2">Date of Birth</td>
                            <td className="border border-azure-200 px-3 py-2 text-sm text-gray-900 w-1/2">
                              {data.dateOfBirth || ''}
                            </td>
                          </tr>
                          <tr>
                            <td className="border border-azure-200 px-3 py-2 text-sm font-medium text-gray-700 w-1/2">Position Applied For</td>
                            <td className="border border-azure-200 px-3 py-2 text-sm text-gray-900 w-1/2">
                      ...
                      <table className="w-full border-collapse border border-azure-200">
                        <thead>
                          <tr className="bg-gray-100">
                            <th className="border border-azure-200 px-3 py-2 text-left text-sm font-medium text-gray-700 w-3/4">Consent Statement</th>
                            <th className="border border-azure-200 px-3 py-2 text-center text-sm font-medium text-gray-700 w-1/8">Yes</th>
                            <th className="border border-azure-200 px-3 py-2 text-center text-sm font-medium text-gray-700 w-1/8">No</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td className="border border-azure-200 px-3 py-2 text-sm text-gray-700">
                            ...
                            <td className="border border-azure-200 px-3 py-2 text-center">
                              <div className="flex flex-col items-center justify-center h-full">
                                <input
                                  type="checkbox"
                                  checked={data.consent1 === 'yes'}
                                  readOnly
                                  className="w-5 h-5 x-mark rounded border-azure-100 cursor-default"
                                />
          ...
          <div className="w-full">
            <div className="border border-azure-100 rounded-lg p-6 w-full">
              <div className="space-y-6">
                ...
                <div className="mt-6">
                  <div className="bg-azure-700 text-white px-6 py-3">
                  ...
                  <div className="border border-azure-100 rounded-b-lg p-4 w-full mt-3">
                    <div className="overflow-x-auto">
                      <table className="w-full border-collapse border border-azure-200">
                        <thead>
                          <tr className="bg-gray-100">
                            <th className="border border-azure-200 px-3 py-2 text-left text-sm font-medium text-gray-700">Question</th>
                            <th className="border border-azure-200 px-3 py-2 text-center text-sm font-medium text-gray-700">Yes/No</th>
                            <th className="border border-azure-200 px-3 py-2 text-center text-sm font-medium text-gray-700">Details</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td className="border border-azure-200 px-3 py-2 text-sm text-gray-900">Have you ever injured yourself at work or suffered an industrial disease?</td>
                            <td className="border border-azure-200 px-3 py-2 text-center">
                            ...
                            <td className="border border-azure-200 px-3 py-2">
                          ...
                          <tr>
                            <td className="border border-azure-200 px-3 py-2 text-sm text-gray-900">Have you ever had difficulties wearing PPE?</td>
                            <td className="border border-azure-200 px-3 py-2 text-center">
                              <div className="flex justify-center gap-6">
                                <div className="flex flex-col items-center">
                                  <input
                          ...
                          <tr>
                            <td className="border border-azure-200 px-3 py-2 text-sm text-gray-900">Have you ever worked with hazardous materials?</td>
                            <td className="border border-azure-200 px-3 py-2 text-center">
                              <div className="flex justify-center gap-6">
                                <div className="flex flex-col items-center">
                                  <input
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-sm text-gray-900">Applicant's Signature:</span>
                            <div className="flex-1 border-b-2 border-dashed border-azure-200"></div>
                          </div>
                          <div className="h-16">
                            {data.declarationSignature ? (
                              <img src={data.declarationSignature} alt="Declaration Signature" className="max-w-full max-h-full" />
                            ) : (
                              <div className="w-full h-16 border-b-2 border-dashed border-azure-200"></div>
                            )}
                          </div>
                        </div>
                        <div>
...
function Field({ label, value }: { label: string; value?: React.ReactNode }) {
  return (
    <div>
      ...
      <div className="border border-azure-200 h-8 rounded-sm px-2 flex items-center text-gray-900 bg-white">
        {value || ''}
      </div>
    </div>
  );
