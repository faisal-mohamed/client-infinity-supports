  ...
  return (
    <div className="bg-slate-50 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow-lg border border-azure-100" style={{ minHeight: '1056px' }}>
            ...
            <div className="mt-16">
              ...
              <div className="flex justify-between items-start gap-8">
                <div className="flex-1">
                  ...
                  <div className="border-b-2 border-azure-200 h-12 bg-transparent flex items-center">
                    {data?.signature ? (
