    ...
    >
      {Array.from({ length }, (_, i) => (
        <input
          ...
          onPaste={handlePaste}
          className={`border border-azure-200 text-center text-sm text-black ${
...
const SignaturePad = ({ 
  ...
  return (
    <>
      ...
      <div
        className={`absolute border border-azure-200 bg-white flex flex-col items-center justify-center ${readOnly ? 'cursor-not-allowed opacity-80' : 'cursor-pointer'}`}
            ...
            <div className="flex justify-between items-center mt-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-1 bg-azure-600 text-white rounded hover:bg-azure-700 disabled:bg-gray-300 disabled:cursor-not-allowed"
                >
                  Save
                </button>
              </div>
  ...
  return (
    <>
      ...
      >
        ...
        <div 
          className={`absolute ${readOnly ? 'cursor-not-allowed opacity-50' : 'cursor-pointer hover:bg-azure-50 hover:bg-opacity-30'}`}
          style={{ 
            zIndex: 100,
            top: -5,
            left: -5,
          ...
          <div className="bg-white p-4 rounded shadow-lg w-[400px]">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-2 border-2 border-azure-100 rounded-lg focus:ring-2 focus:ring-gold-500/30 focus:border-gold-500"
              />
            </div>
            ...
            <div className="flex justify-end gap-2 mt-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-azure-600 text-white rounded hover:bg-azure-700 disabled:bg-gray-300 disabled:cursor-not-allowed"
              >
                Save
              </button>
            </div>
    ...
    <div className="w-full">
      ...
      {showButtons && (
        <div className="flex gap-4 mt-6 justify-center sticky bottom-4">
          ...
          <button className="px-6 py-2 bg-azure-600 text-white rounded hover:bg-azure-700">
            Submit Form
          </button>
        </div>
      )}
