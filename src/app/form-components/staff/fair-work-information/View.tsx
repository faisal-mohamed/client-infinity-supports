...
export default function FairWorkInformationView({ excludeLastPage = false, children, data = {} }: { excludeLastPage?: boolean; children?: React.ReactNode; data?: any }) {
  ...
  useEffect(() => {
    ...
    const renderPdf = async () => {
      ...
      setIsRendering(true);
      try {
        console.log('Starting PDF rendering for Fair Work Information Statement');
        ...
        const url = '/stafForms/Fair-Work-Information-Statement.pdf';
      ...
      <div className="max-w-4xl mx-auto">
        {isRendering && (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600">Loading Fair Work Information Statement...</p>
          </div>
        )}
