                ...
                <div className="ml-4 space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-1">
                      <div className="w-8 h-6 border-b-2 border-azure-200 flex items-center justify-center text-xs">
                      ...
                      <span className="text-xs">/</span>
                      <div className="w-12 h-6 border-b-2 border-azure-200 flex items-center justify-center text-xs">
              ...
              <div className="border border-black rounded-lg p-4">
                ...
                {isAdminView && data?.staffSignature && !data?.adminSignature ? (
                  ...
                  <form onSubmit={handleAdminSubmit} className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-2 py-1 border border-azure-200 rounded text-xs"
                            required
                          />
                        </div>
                        <div>
                    ...
                    <div className="mt-4 pt-4 border-t border-azure-100">
                      ...
                      <SignatureCanvas
                        ...
                        width={400}
                        height={120}
                        className="bg-white border border-azure-200"
                      />
                      <div className="mt-2">
                        ...
                        <input
                          ...
                          className="px-2 py-1 border border-azure-200 rounded text-xs"
                          required
                        />
                      </div>
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={submitting}
                      className="mt-4 px-4 py-2 bg-azure-700 text-white rounded hover:bg-azure-800 disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    {data?.adminSignature && (
                      <div className="col-span-2 mt-4 pt-4 border-t border-azure-100">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
...
function Field({ label, value }: { label: string; value?: React.ReactNode }) {
  return (
    <div className="flex items-center">
      ...
      <div className="flex-1 border-b-2 border-azure-200 h-6 ml-2">
        {value || ''}
      </div>
    </div>
  );
...
function SignatureField({ label, value }: { label: string; value?: string }) {
  return (
    <div className="flex items-center">
      <span className="text-xs font-medium text-gray-700 mr-2">{label}:</span>
      <div className="flex-1 border-b-2 border-azure-200 h-16 ml-2 flex items-center justify-center">
        {value ? (
          <img 
            src={value} 
            alt="Signature" 
...
function Section({ title }: { title: string }) {
  return (
    <div className="mt-4 mb-2 font-semibold text-gray-800 border-b border-azure-200 pb-1">{title}</div>
  );
}

function Footer({ meta }: { meta: { website?: string; version?: string; reviewDate?: string } }) {
  return (
    <div className="text-[10px] text-gray-600 grid grid-cols-1 sm:grid-cols-3">
