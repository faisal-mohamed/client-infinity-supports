...
interface TFNDeclarationFormProps {
  meta?: {
    website?: string;
    version?: string;
    reviewDate?: string;
...
export default function TFNDeclarationForm({ meta }: TFNDeclarationFormProps) {
  ...
  useEffect(() => {
    ...
    const renderPdf = async () => {
      ...
      setIsRendering(true);
      try {
        console.log('Starting PDF rendering for TFN Declaration Form');
        ...
        const url = '/stafForms/TFN_declaration_form.pdf';
      ...
      <div className="bg-white w-full max-w-[900px] mx-auto rounded-xl shadow border p-4">
        {isRendering && (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600">Loading TFN Declaration Form...</p>
          </div>
        )}
        ...
        {error && (
          <div className="text-sm text-red-600 mt-2">
            ...
            <iframe 
              src="/stafForms/TFN_declaration_form.pdf" 
              className="w-full h-96 border border-gray-300"
              title="TFN Declaration Form PDF"
            />
          </div>
        )}
      </div>
