        ...
        <div className="text-sm text-gray-900 font-sans">
          ...
          <div className="mb-6">
            <label className="inline-flex items-center space-x-2">
              <input
                className="form-checkbox border border-azure-200 rounded-sm"
                type="checkbox"
            ...
            <label className="inline-flex items-start space-x-2 mt-3">
              <input
                className="form-checkbox border border-azure-200 rounded-sm mt-1"
                type="checkbox"
            ...
            <div className="mt-4 border border-azure-200 p-2 min-h-[80px] text-sm">
