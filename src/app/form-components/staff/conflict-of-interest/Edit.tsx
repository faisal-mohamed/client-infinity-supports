  ...
  const renderTextField = (field: keyof ConflictOfInterestFormData, className: string = '') => {
    return (
      <input
        ...
        disabled={readOnly}
        className={`w-full h-8 px-2 border border-azure-100 bg-white rounded ${className} ${readOnly ? 'bg-gray-100' : ''}`}
      />
    );
  };
  ...
  const renderDateField = (field: keyof ConflictOfInterestFormData) => {
    return (
      <input
        ...
        onChange={(e) => handleInputChange(field, e.target.value)}
        disabled={readOnly}
        className={`w-full h-8 px-2 border border-azure-100 bg-white rounded ${readOnly ? 'bg-gray-100' : ''}`}
      />
    );
  };
  ...
  const renderTextareaField = (field: keyof ConflictOfInterestFormData, rows: number = 4) => {
    return (
      <textarea
        ...
        disabled={readOnly}
        rows={rows}
        className={`w-full min-h-[4rem] px-2 py-1 border border-azure-100 bg-white rounded resize-y ${readOnly ? 'bg-gray-100' : ''}`}
        style={{
          minHeight: '4rem',
          maxHeight: '12rem',
          overflowY: 'auto'
      ...
      <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-4">
            ...
            <div className="border border-azure-100">
              <div className="grid grid-cols-1 sm:grid-cols-2">
                <div className="bg-gray-100 border-r border-azure-100 p-3 text-sm font-medium text-gray-800">Name <span className="text-red-500">*</span></div>
                <div className="p-3">
                  {renderTextField('name')}
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 border-t border-azure-100">
                <div className="bg-gray-100 border-r border-azure-100 p-3 text-sm font-medium text-gray-800">Position <span className="text-red-500">*</span></div>
                <div className="p-3">
                  {renderTextField('position')}
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 border-t border-azure-100">
                <div className="bg-gray-100 border-r border-azure-100 p-3 text-sm font-medium text-gray-800">Department <span className="text-red-500">*</span></div>
                <div className="p-3">
                  {renderTextField('department')}
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 border-t border-azure-100">
                <div className="bg-gray-100 border-r border-azure-100 p-3 text-sm font-medium text-gray-800">Date <span className="text-red-500">*</span></div>
                <div className="p-3">
            ...
            {formData.hasConflict === 'no' && (
              <div className="mb-3">
                ...
                <textarea
                  ...
                  disabled
                  rows={3}
                  className="w-full min-h-[3rem] px-2 py-1 border border-azure-100 bg-gray-100 rounded resize-y cursor-not-allowed"
        ...
        >
          ...
          <div className="mb-4">
            ...
            <div className="p-4 border border-gold-300 rounded-md bg-gold-50 text-sm text-gold-800 mb-4">
              HR/Management acknowledgement is completed by administration after you submit this form.
            </div>
            <div className="border border-azure-100 p-3 mb-4">
              <div className="mb-3">
          ...
          {/* For HR/Management Use Only */}
          <fieldset className="p-4 border-2 border-dashed border-gold-300 bg-gold-50 rounded-lg space-y-3 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-azure-100 rounded-md bg-gray-100 text-gray-500"
                />
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                ...
                <div className="w-full min-h-[90px] border border-azure-100 rounded-md bg-gray-100 flex items-center justify-center">
