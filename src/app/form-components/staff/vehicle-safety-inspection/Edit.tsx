    ...
    return (
      <div className="flex items-center justify-center">
        <input
          ...
          disabled={readOnly}
          className="w-4 h-4 text-azure-700 border-azure-100 focus:ring-gold-500/30 cursor-pointer"
        />
      </div>
    );
  };
  ...
  const renderTextareaField = (field: keyof VehicleSafetyInspectionFormData, className: string = '') => {
    return (
      <textarea
        ...
        disabled={readOnly}
        rows={2}
        className={`w-full min-h-[2rem] px-2 py-1 border border-azure-100 bg-white rounded resize-y ${className} ${readOnly ? 'bg-gray-100' : ''}`}
        style={{ 
          minHeight: '2rem',
          maxHeight: '10rem',
          overflowY: 'auto'
          ...
          <div className="mb-8">
            ...
            <div className="border border-azure-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 border-b border-azure-100">
                <div className="p-3 bg-gray-100 border-r border-azure-100 font-semibold text-gray-800">
          ...
          <div className="mb-8">
            ...
            <div className="border border-azure-100">
              ...
              {[1, 2, 3, 4, 5].map((num) => {
                ...
                return (
                  <div key={num} className="grid grid-cols-2 sm:grid-cols-4 border-b border-azure-100">
                    <div className="p-3 border-r border-azure-100">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                disabled={readOnly}
                className={`flex-1 h-8 px-2 border border-azure-100 bg-white rounded ${readOnly ? 'bg-gray-100' : ''}`}
              />
            </div>
          </div>
        </FormPage>
