...
export default function VehicleSafetyInspectionView({ 
  ...
  const renderCheckbox = (checked: boolean) => {
    return (
      <div className={`w-4 h-4 border border-gray-400 mx-auto ${checked ? 'bg-black' : 'bg-white'}`}>
            ...
            <div className="border border-gray-300">
              ...
              <div className="border-b border-gray-300">
                ...
                <div className="grid grid-cols-4 border-b border-gray-300">
                  ...
                  <div className="p-3">
                    <div className="w-full min-h-8 px-2 py-1 border border-gray-300 bg-white text-gray-900 text-sm">
