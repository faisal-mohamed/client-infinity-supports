...
export default function DocumentationAcknowledgementView({ 
  ...
  const renderSignature = (signature: string) => {
    if (!signature) {
      return <div className="w-full min-h-32 border-2 border-azure-100 bg-gray-50 flex items-center justify-center text-gray-400 text-base rounded-lg">No signature</div>;
    }
    return (
      <div className="w-full border-2 border-azure-100 bg-white p-4 rounded-lg">
      ...
      <div className="bg-slate-50 py-8">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            <iframe
              src={pdfUrl}
              className="w-full border border-azure-100 rounded"
    ...
    <div className="bg-slate-50 py-8">
      <div className="max-w-5xl mx-auto px-4">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-base text-gray-800 mb-4 leading-relaxed">
              ...
              <a
                ...
                className="text-azure-700 underline hover:text-azure-800"
              >
          ...
          {/* Signature Section */}
          <div className="mt-10 border-t-2 border-azure-100 pt-8">
            <div className="mb-6">
              <label className="block text-base font-semibold text-gray-900 mb-3">Staff Name:</label>
              <div className="w-full min-h-12 px-4 py-3 border-2 border-azure-100 bg-white text-gray-900 text-base rounded-lg">
        ...
        {staffId && (
          <div className="mt-8 text-center space-x-4">
            <button
              ...
              className="px-6 py-3 text-base font-medium bg-azure-700 text-white rounded-lg hover:bg-azure-800 transition-colors shadow-md"
            >
              View PDF
            </button>
            <a
              ...
              download
              className="px-6 py-3 text-base font-medium bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 inline-block transition-colors shadow-md"
            >
              Download PDF
            </a>
          </div>
