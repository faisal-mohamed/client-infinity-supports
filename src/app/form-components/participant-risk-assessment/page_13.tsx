            ...
            <tbody>
              <tr>
                ...
                <td className="border border-black">
                  {getValue("authorisedBy")}
                </td>
                <td className="border border-black text-left px-2">
                  <strong>Role:</strong> {getValue("role")}
                </td>
              </tr>
              <tr>
                <td className="border border-black py-1 text-left px-2">
                ...
                <td className="border border-black text-left px-2">
                  <strong>Date:</strong> {getValue("signatureDate")}
                </td>
              </tr>
              <tr>
                <td className="border border-black py-1 text-left px-2">
                ...
                <td className="border border-black">
                  {getValue("guardianSignature")?.startsWith("data:image") ? (
                    <img
                      src={getValue("guardianSignature")}
                ...
                <td className="border border-black text-left px-2">
                  <strong>Date:</strong> {getValue("guardianDate")}
                </td>
              </tr>

              <tr>
                <td className="border border-black py-1 text-left px-2">
                  <strong>Is a copy supplied to the participant? </strong>{" "}
                  <br />
                  {/* <td className="border border-black text-left px-2"> */}
