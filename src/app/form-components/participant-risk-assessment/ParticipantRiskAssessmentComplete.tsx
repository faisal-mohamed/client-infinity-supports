        ...
        <table className="w-full border border-black border-collapse text-xs">
          ...
          <tbody>
            <tr>
              ...
              <td className="border border-black p-2 align-top">
                <ul className="list-disc list-inside space-y-1">
                  <li>Ring 000 and provide details of the fire then ring supervisor.Ring 000 and notify supervisor</li>
            ...
            <tr>
              <td className="border border-black p-2 align-top">
                <ul className="list-disc list-inside space-y-1">
                  <li>Do not move a participant unless they are exposed to a life-threatening situationt</li>
              ...
              <td className="border border-black p-2 align-top">
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>Consider locking down the building to prevent unauthorised entry.Consider locking down the building to prevent unauthorised entry.  </li>
                  <li>Follow closely the instructions of emergency services personnel and campus wardens.</li>
