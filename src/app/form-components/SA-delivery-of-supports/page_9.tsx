  ...
  return (
    <A4PageWrapper>
      <div className="h-full flex flex-col p-6">
          ...
          <div className="space-y-4 flex-1">
            <table className="w-full border border-black" style={{ fontSize: '13px' }}>
              <tbody>
                ...
                <tr>
                  <td className="border border-black p-4 leading-loose">
                    I conrm that this agreement has been explained to the person
                    receiving the services (participant) and that they agree to
        ...
        {/* Footer */}
        <div className="flex justify-between items-center text-xs font-bold  border-t border-gray-200">
