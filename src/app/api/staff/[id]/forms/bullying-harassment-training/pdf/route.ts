...
export async function GET(
  ...
  try {
    ...
    const settings = await getStaffSettingsForForm(staffId, 'bullying_harassment_training');

    console.log('⚙️ [PDF API] Staff settings for Bullying & Harassment Training:', settings);
