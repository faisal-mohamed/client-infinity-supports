...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    // Use generic StaffFormSubmission table (Employee Details uses this)
    ...
    const updated = await db.staffFormSubmission.update({
      ...
      data: {
        data: {
          ...
          employmentStatus,
          payRate,
          schadsLevel: schadsLevel, // Note: View component uses schadsScore, but we'll store as schadsLevel
        },
        adminSignature,
