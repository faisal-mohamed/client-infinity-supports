    ...
    return (
      <div className="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">Loading Form</h3>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 text-gray-700">
              <div className="flex items-center">
                ...
                <div className="text-center sm:text-left">
                  <p className="font-semibold text-gray-900 text-sm sm:text-base">{batchData.client.name}</p>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-white px-4 sm:px-8 py-4 sm:py-6 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-3 sm:space-y-0">
              ...
              <div className="flex sm:hidden items-center space-x-4 self-center">
                <div className="text-center">
                  <div className="text-xl font-bold text-indigo-600">{batchData.signatureForms.length}</div>
                      ...
                      <div className="flex-shrink-0 w-full sm:w-auto sm:ml-6 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                        ...
                        {batchData.isCompleted && (
                          <button
                            ...
                            className="inline-flex items-center justify-center px-4 py-2.5 border-2 border-gray-300 text-sm font-medium rounded-lg sm:rounded-xl text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                            title="Download PDF"
                          >
                            {isDownloading ? (
