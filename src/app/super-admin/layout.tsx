...
const menuItems = [
  { href: '/super-admin/dashboard', label: 'Dashboard', icon: FaTachometerAlt },
  { href: '/super-admin/providers', label: 'Providers', icon: FaBuilding },
  { href: '/super-admin/subscriptions', label: 'Subscriptions', icon: FaCreditCard },
  { href: '/super-admin/settings', label: 'Global Settings', icon: FaCog },
  { href: '/super-admin/compliance', label: 'Compliance', icon: FaClipboardCheck },
  { href: '/super-admin/audit', label: 'Audit Logs', icon: FaHistory },
  { href: '/super-admin/templates', label: 'Form Templates', icon: FaFileAlt },
  { href: '/super-admin/notifications', label: 'Email & Notifications', icon: FaEnvelope },
  { href: '/super-admin/reports', label: 'Reports', icon: FaChartBar },
];
    ...
    <div className="min-h-screen bg-azure-50/30">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-14 bg-white border-b border-azure-100 flex items-center justify-between px-4 z-30 shadow-soft">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-bold text-sm text-azure-700">Infinity Supports</span>
        </div>
        <button
            ...
            <div className="p-4 border-t border-azure-100">
              <div className="p-3 rounded-xl bg-azure-50 mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm font-semibold text-azure-700">Super Admin</p>
                </div>
              </div>
              <button
                onClick={() => signOut({ callbackUrl: '/super-admin/login' })}
                className="w-full px-4 py-2.5 text-sm font-medium text-azure-500 hover:text-azure-700 hover:bg-azure-50 rounded-xl transition-colors text-left"
              >
                Sign Out
              </button>
            </div>
        ...
        <aside className="hidden lg:flex lg:w-64 flex-col fixed inset-y-0 bg-white border-r border-azure-100">
          ...
          <div className="h-16 flex items-center px-6 border-b border-azure-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-bold text-sm text-azure-700 block leading-tight">Infinity Supports</span>
                <span className="text-[10px] text-gold-600 font-medium tracking-wider uppercase">Platform Admin</span>
              </div>
            </div>
          </div>
