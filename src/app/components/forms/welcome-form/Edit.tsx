...
export const FORM_SECTIONS = [
  {
    id: "welcomePackAcknowledgement",
    title: "Welcome Pack Receipt Acknowledgement",
    icon: FaClipboardCheck, // Replace with an appropriate icon
    description: "Confirm receipt and understanding of the Welcome Pack",
    fields: [ "name", "signature", "relationship", "date"],
    requiredFields: ["name", "signature", "relationship", "date"]
  },
];
...
const WelcomeFormEdit: React.FC<FormProps> = ({
  formData,
  commonFieldsData,
  onChange,
  onSubmit,
      ...
      <div className="w-full max-w-2xl mx-auto pt-2 md:pt-6 px-2">
        ...
        {/* <nav className="flex items-center justify-between gap-2 overflow-visible pb-2 relative">
          {FORM_SECTIONS.map((section, idx) => {
            ...
            return (
              <div key={section.id} className="relative flex flex-col items-center group" style={{textAlign: 'center'}}>
                <button
                  type="button"
...
export default WelcomeFormEdit;
