...
const PersonCentredPlanEdit: React.FC<FormProps> = ({
  ...
  const renderDropdown = (
    ...
    <div className="flex flex-col gap-1">
      <label htmlFor={name} className="text-xs font-medium text-azure-600 mb-1">
        {label}
        {required && <span className="text-red-500 ml-1">*</span>}
      </label>
      <select
              ...
              {FORM_SECTIONS[currentStep].id === "goals" ? (
                ...
                <div className="space-y-6">
                  {Array.from({ length: numberOfGoals }, (_, i) => i + 1).map((num) => (
                    <div key={`goal-${num}`} className="border border-azure-100 rounded-lg p-4 bg-azure-50">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold text-azure-700">Goal {num}</h3>
                  ...
                  <div className="flex justify-center mt-4">
                    <button
                      ...
                      className="flex items-center gap-2 px-6 py-3 bg-azure-600 text-white rounded-lg hover:bg-azure-700 transition-colors duration-200 font-medium shadow-md hover:shadow-lg"
                    >
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-azure-100 rounded-lg p-4 bg-azure-50">
                    <h3 className="text-lg font-semibold mb-4 text-azure-700">Organization Information</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {/* Informal Supports */}
                  <div className="border border-azure-100 rounded-lg p-4 bg-azure-50">
                    <h3 className="text-lg font-semibold mb-4 text-azure-700">Informal Supports</h3>
                    <div className="space-y-4">
                      {[1, 2, 3, 4].map((num) => (
                        <div key={num} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-3 bg-white rounded border">
                          <h4 className="md:col-span-3 text-sm font-medium text-azure-500 mb-2">Support Person {num}</h4>
