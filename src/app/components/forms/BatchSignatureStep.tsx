...
const BatchSignatureStep: React.FC<BatchSignatureStepProps> = ({
  ...
  return (
    <div className="max-w-xl mx-auto bg-white rounded-3xl shadow-2xl border border-azure-50 px-6 py-8 md:px-12 md:py-10 flex flex-col gap-8 transition-all duration-300 mt-8">
      ...
      <button
        className="w-full mt-4 flex items-center justify-center gap-2 px-3 py-2 rounded-lg font-semibold text-base bg-gradient-to-r from-blue-600 to-green-400 text-white hover:from-blue-700 hover:to-green-500 shadow-xl transition"
