  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 to-slate-100 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-4 sm:p-6 md:p-8 hover:shadow-xl hover:border-rose-500 transition-shadow duration-300">
          {/* Main Header Section */}
          <div className="flex flex-col gap-6 md:gap-8 lg:flex-row lg:items-center lg:justify-between mb-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
              ...
              <div className="flex gap-4 items-center">
                <div className="relative flex-shrink-0">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-rose-500 to-rose-400 rounded-2xl flex items-center justify-center shadow-lg">
                    <FaUser className="h-7 w-7 sm:h-8 sm:w-8 text-white" />
                  </div>
                  <div className="absolute -bottom-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-rose-500 rounded-full border-4 border-white shadow-md"></div>
                </div>
                <div className="min-w-0">
                  <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 mb-1 truncate">
                    {client?.name}
                  </h1>
            ...
            <div className="self-start sm:self-auto">
              <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl p-4 sm:p-6 border border-slate-200 w-full sm:w-auto">
                <div className="text-center">
                  ...
                  <div className="text-sm sm:text-lg font-bold text-slate-900 mb-1">
                    {stats.completed}/{stats.total}
                  </div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
  {[
    ...
    <div
      key={index}
      className="bg-white rounded-xl p-4 sm:p-6 border border-slate-200 shadow-sm hover:border-rose-500 hover:shadow-md transition-all duration-200"
    >
      <div className="flex items-center gap-3">
