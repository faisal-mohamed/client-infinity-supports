...
export default function StaffFormViewPageClient() {
  ...
  const loadAssignmentData = async () => {
    try {
      ...
      const assignmentRes = await fetch(`/api/staff-form-assignments/${assignmentId}?staffId=${staffId}`);
      if (!assignmentRes.ok) {
      ...
      const resolvedStaffId = assignment?.staffId || staffId;

      if (!currentFormKey || !resolvedStaffId) {
        console.error('❌ [View Form] Missing required data:', { formKey: currentFormKey, staffId: resolvedStaffId, assignment });
  ...
  if (loading) {
    return (
      <div className="bg-azure-50 to-azure-100 min-h-screen flex items-center justify-center">
        <div className="flex justify-center items-center min-h-[60vh]">
          <div className="text-center">
            {/* Spinner */}
            <div className="w-20 h-20 border-4 border-t-gold-500 border-gold-200 rounded-full animate-spin mx-auto mb-3"></div>

            {/* Text */}
            <h3 className="text-base font-semibold text-azure-800 mb-2">
              Loading View Form
            </h3>
      ...
      <div className="">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center bg-white rounded-xl shadow-sm p-12">
            ...
            <p className="text-azure-400 mb-8 max-w-md mx-auto">
              {!assignment 
      ...
      <div className="">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center bg-white rounded-xl shadow-sm p-12">
            ...
            <Link 
              href={`/admin/staff/${staffId}`}
              className="inline-flex items-center gap-2 px-6 py-3 bg-azure-600 text-white rounded-lg hover:bg-azure-700 transition-colors"
            >
              <FaArrowLeft className="h-3.5 w-3.5 flex-shrink-0" />
              <span>Back to Forms List</span>
            </Link>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3 flex-shrink-0">
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-2 bg-azure-700 text-white font-medium rounded-xl hover:bg-azure-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm "
                title="Download PDF"
              >
                {downloadingPDF ? (
                  <>
      ...
      <div className="">
        {isEmployeeDetailsForm ? (
            ...
            return (
              <div className="space-y-6">
                ...
                {showAdminSection && (
                  <div className="bg-white rounded-2xl border border-azure-100/60 shadow-soft overflow-hidden">
                    <div className="p-6">
                      <h3 className="text-base font-semibold text-azure-700 mb-4">Admin Section - Office Use Only</h3>
                      <form onSubmit={handleAdminSubmit} className="space-y-6">
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full px-3 py-2 border border-azure-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-azure-500"
                                required
                              />
                            </div>
                            <div>
                        ...
                        {/* Admin Signature */}
                        <div className="border-t border-azure-200 pt-6">
                          <label className="block text-sm font-medium text-azure-600 mb-3">
                          ...
                          <SignatureCanvas
                            ...
                            width={500}
                            height={150}
                            className="bg-white border-2 border-azure-300 rounded-lg"
                          />
                          <div className="mt-4">
                            <label className="block text-sm font-medium text-azure-600 mb-2">
                            ...
                            <input
                              ...
                              className="px-3 py-2 border border-azure-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-azure-500"
                              required
                            />
                          </div>
                        </div>
                        ...
                        {/* Submit Button */}
                        <div className="flex justify-end gap-3 pt-4 border-t border-azure-200">
                          {editingAdmin && (
                            <button
                              type="button"
                              onClick={() => {
                              ...
                              className="px-6 py-2 bg-azure-500 text-white font-medium rounded-lg hover:bg-azure-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-azure-400 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
                            >
                              Cancel
                            </button>
                          )}
                          <button
                            type="submit"
                            disabled={submittingAdmin}
                            className="px-6 py-2 bg-azure-700 text-white font-medium rounded-lg hover:bg-azure-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 flex items-center gap-2"
                          >
                            {submittingAdmin ? (
                              <>
            ...
            return (
              <div className="space-y-6">
                ...
                {showAdminSection && (
                  <div className="bg-white rounded-2xl border border-azure-100/60 shadow-soft overflow-hidden">
                    <div className="p-6">
                      <h3 className="text-base font-semibold text-azure-700 mb-4">Manager Acknowledgement - Office Use Only</h3>
                      ...
                      {adminHasSigned && !editingAdmin ? (
                        ...
                        <form onSubmit={handleConflictOfInterestAdminSubmit} className="space-y-6">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <input
                                ...
                                className="w-full h-10 px-3 border border-azure-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-azure-500"
                                required
                              />
                              </div>
                            <div>
                            ...
                            <textarea
                              ...
                              rows={3}
                              className="w-full px-3 py-2 border border-azure-300 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-azure-500 resize-y"
                            />
                              </div>
                          ...
                          <div>
                            ...
                            <div className="border border-azure-300 rounded-lg p-2">
                              <SignatureCanvas
          ...
          (() => {
            ...
            return (
              <div className="bg-white rounded-2xl border border-azure-100/60 shadow-soft overflow-hidden p-2 md:p-6">
                <OrientationView
