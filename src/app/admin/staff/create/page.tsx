...
export default function StaffCreatePage() {
  ...
  return (
    <div className="bg-azure-50 to-azure-100 min-h-screen">
      ...
      <div className="bg-white shadow-sm border-b border-azure-200">
        <div className="">
          ...
          <div className="flex items-center mb-4">
            <Link 
              href="/admin/staff"
              className="flex items-center px-3 py-2 text-azure-600 hover:text-azure-900 hover:bg-azure-100 rounded-lg transition-all duration-200 group"
            >
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-azure-900 mb-1">Add New Staff</h1>
              <p className="text-azure-600">Create a new staff member account</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-soft border border-azure-100/60 p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* First Name */}
            <div>
              <label className="block text-sm font-bold text-azure-600 mb-2">
              ...
              <input 
                ...
                className={`w-full border rounded-xl px-4 py-3 focus:outline-none focus:ring-2 transition-all ${
                  errors.firstName 
                    ...
                    : 'border-azure-300 focus:ring-gold-500'
                }`}
          ...
          {/* Action Buttons */}
          <div className="flex justify-end gap-4 pt-4 border-t border-azure-200">
            <Link 
              href="/admin/staff" 
              className={`px-6 py-3 border border-azure-300 rounded-xl text-azure-600 hover:bg-azure-50 transition-all duration-200 font-medium flex items-center gap-2 ${
            ...
            <button 
              ...
              className="px-5 py-2.5 bg-azure-700 hover:bg-azure-600 text-white rounded-xl font-medium transition-all duration-200 shadow-soft  disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {creating ? (
                <>
