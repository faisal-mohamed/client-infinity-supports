...
import { FaTachometerAlt, FaUsers, FaFileAlt, FaCog, FaBars, FaTimes, FaClipboardCheck, FaCreditCard, FaUserTie, FaClipboardList, FaFolderOpen } from 'react-icons/fa';
...
const menuItems = [
  ...
  { href: '/admin/documents', label: 'Documents', icon: FaFolderOpen },
