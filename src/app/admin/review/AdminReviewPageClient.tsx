...
export default function AdminReviewPageClient({
    ...
    const activeTabClass = "inline-flex items-center px-6 py-4 border-b-2 border-rose-500 text-sm font-bold text-rose-600 transition-all duration-200";
    const inactiveTabClass = "inline-flex items-center px-6 py-4 border-b-2 border-transparent text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 transition-all duration-200";

    return (
        <div className="bg-white min-h-screen">
            <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-8">
                {/* Header Card */}
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8 mb-6 sm:mb-8 hover:shadow-xl transition-shadow duration-300 animate-[fadeIn_0.5s_ease-out]">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 md:gap-0">
                        <div className="flex items-center gap-6">
                            ...
                            <div>
                                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 font-[Montserrat]">
                ...
                {/* Search & Tabs Card */}
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8 mb-6 sm:mb-8 hover:shadow-xl transition-shadow duration-300 animate-[fadeInUp_0.5s_ease-out]">
                            ...
                            <nav className="-mb-px flex space-x-8">
                                ...
                                >
                                    ...
                                    {reviewStatus === "pending_admin_review" && pagination.totalCount > 0 && (
                                        <span className="ml-2 bg-gradient-to-r from-rose-500 to-rose-600 text-white text-xs rounded-full w-6 h-6 flex items-center justify-center font-bold shadow-md">
                ...
                {/* Table Card */}
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300 animate-[fadeInUp_0.6s_ease-out]">
                    <div className="overflow-hidden bg-white shadow">
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200 text-sm">
                                <thead className="bg-white">
                                    <tr>
                                        <th className="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider border-b-2 border-slate-500">
                                            <input type="checkbox" className="accent-rose-500 rounded border-gray-300" />
                                        </th>
                                        <th className="px-6 py-4 text-left text-xs font-bold text-gray-600 uppercase tracking-wider border-b-2 border-slate-500">
                                            NAME
                                        </th>
                                ...
                                <tbody className="divide-y divide-gray-100 bg-white border-t border-gray-200">
                                    {loading ? (
                                        <tr>
                                            <td colSpan={6} className="px-6 py-16 text-center">
                                                <div className="flex flex-col items-center">
                                                    <div className="w-16 h-16 border-4 border-t-rose-500 border-rose-200 rounded-full animate-spin mb-4"></div>
                                                    <p className="text-gray-500 font-medium">Loading review dashboard...</p>
                                                </div>
                                            </td>
                                        </tr>
                                    ) : clients.length === 0 ? (
                                        <tr>
                                            <td colSpan={6} className="px-6 py-16 text-center text-gray-500 font-medium italic">
                                        ...
                                        clients.map((client) => {
                                            ...
                                            return (
                                                <tr key={client.id} className="hover:bg-rose-50 transition-all duration-200">
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <input type="checkbox" className="accent-rose-500 rounded border-gray-300" />
                                                    </td>
                                                    <td className="px-6 py-4 font-semibold text-gray-900">
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-9 h-9 flex items-center justify-center bg-rose-100 text-rose-600 rounded-lg font-bold border border-rose-200 shadow-sm">
                                                                {firstLetter}
                                                            </div>
                                                            <div>
                                                                <div className="text-sm font-bold text-slate-800 font-[Montserrat]">{fullName}</div>
                                                                <div className="text-xs text-slate-500 font-medium whitespace-nowrap overflow-hidden text-ellipsis max-w-[150px]">
                                                    ...
                                                    <td className="px-6 py-4 text-gray-700 whitespace-nowrap">
                                                        {state ? (
                                                            <span className="inline-block text-xs font-bold bg-rose-100 text-rose-700 px-3 py-1 rounded-full border border-rose-200">
                                                    ...
                                                    <td className="px-6 py-4 text-right">
                                                        <Menu as="div" className="relative inline-block text-left">
                                                            <MenuButton className="text-slate-500 hover:text-rose-600 transition p-2 hover:bg-rose-50 rounded-lg">
                                                            ...
                                                            >
                                                                <MenuItems
                                                                    anchor="bottom end"
                                                                    className="w-44 origin-top-right bg-white border border-gray-200 rounded-xl shadow-xl focus:outline-none z-50 p-1 mt-2 [--anchor-gap:8px]"
                                                                >
                                                                    <div className="py-1">
                                                                        <MenuItem>
                                                                            {({ active }) => (
                                                                                <Link
                                                                                    ...
                                                                                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${active ? 'bg-rose-50 text-rose-600' : 'text-slate-700'}`}
                                                                                >
                                                                        ...
                                                                        <MenuItem>
                                                                            {({ active }) => (
                                                                                <Link
                                                                                    ...
                                                                                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${active ? 'bg-green-50 text-green-600' : 'text-slate-700'}`}
                                                                                >
                        ...
                        <div className="px-6 sm:px-8 py-6 bg-white border-t border-gray-200">
                            <div className="flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-0">
                                <div className="flex flex-col sm:flex-row items-center gap-6">
                                    ...
                                    <div className="relative inline-block">
                                        ...
                                        <select
                                            ...
                                            className="cursor-pointer appearance-none border border-rose-300 text-sm text-rose-700 font-bold bg-white py-2 pl-4 pr-10 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 hover:shadow-md transition-all duration-200"
                                        >
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-sm text-gray-700 font-bold bg-rose-50 px-4 py-2 rounded-xl border border-rose-100">
                                        Page{" "}
                                        <span className="text-rose-600 font-black">{pagination.page}</span>
                                        {" "}of{" "}
                                        <span className="text-rose-600 font-black">{pagination.totalPages}</span>
                                    </span>
