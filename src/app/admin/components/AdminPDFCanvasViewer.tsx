        ...
        >
          ...
          <img
            ...
            style={{ 
              ...
              <div 
                className="w-full flex items-center justify-center rounded-2xl border border-gray-100"
                style={{ minHeight }}
              >
                <div className="text-center py-8">
                  <div className="w-12 h-12 border-4 border-t-blue-500 border-blue-200 rounded-full animate-spin mx-auto mb-4"></div>
                  <p className="text-gray-600 text-sm">Loading page {pageNum}...</p>
                </div>
              </div>
            ) : (
              <div 
                className="w-full flex items-center justify-center rounded-2xl border border-gray-100 bg-gray-50"
                style={{ minHeight }}
              >
