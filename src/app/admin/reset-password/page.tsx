...
//                 disabled={isLoading}
//                 className="text-sm text-azure-700 hover:underline disabled:text-azure-300"
//               >
...
//                 disabled={isLoading}
//               />
//               <p className="text-xs text-azure-400 mt-1">Must be at least 6 characters long</p>
//             </div>
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Loading reset password page...</div>}>
      <ResetPasswordClient />
    </Suspense>
  );
}
