...
const Page11: React.FC<Page11Props> = ({ schema, data, commonFieldsData, settings, images }) => {
  ...
  return (
    <A4PageWrapper footer={footer}>
      <div className="flex flex-col h-full font-sans text-[11px] px-6 pt-6 pb-4">
        {/* Logo */}
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <table className="w-full border border-black border-collapse text-[10px]">
            <tbody>
              <tr>
                <td className="border border-black p-2 align-top w-1/2">Pandemic</td>
                <td className="border border-black p-2 align-top">
              ...
              <tr className="font-bold text-black">
                <td className="border border-black p-2">Possible scenarios of concern</td>
          ...
          <div className="flex flex-col flex-1">
            ...
            <table className="w-full border border-black border-collapse text-[10px] leading-[1.6]">
              <thead>
                <tr className="bg-gray-300 font-bold text-black">
                  <th className="border border-black p-2 text-left w-1/2">Evacuation Procedures</th>
                  <th className="border border-black p-2 text-left w-1/2">FIRE</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="border border-black p-2 align-top">
                    <ul className="list-disc list-inside space-y-1">
                      <li>Prepare to evacuate.</li>
                      <li>
                        Get your environment ready to be left unattended. Shut down electrical/electronic devices; turn off gas if safe to do so.
                      </li>
                      <li>
