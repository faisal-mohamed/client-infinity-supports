...
// const Page12: React.FC<any> = ({data, commonFieldsData, settings, schema, images} : any) => {
//   return (
//     <A4PageWrapper>
...
const Page12: React.FC<any> = ({ data, commonFieldsData, settings, schema, images }) => {
  const footer = (
    <div className="flex justify-between text-xs px-2">
      <div>Website: {settings?.company_website}</div>
      <div>{settings?.participant_risk_assessment}</div>
  ...
  return (
    <A4PageWrapper footer={footer}>
      <div className="flex flex-col h-full w-full px-6 pt-6 pb-4 font-sans text-[11px]">
        ...
        {/* Main Content */}
        <div className="flex-1 flex flex-col">
          <section className="border border-black flex-1 flex flex-col text-[10px]">
            {/* Evacuation Instructions */}
            <div className="grid grid-cols-1 md:grid-cols-2 border-b border-black flex-grow">
              <ul className="list-disc list-inside p-4 border-r border-black space-y-1 leading-snug">
                <li>Leave the building via the nearest safe route.</li>
                <li>Obey all directions from emergency services.</li>
                <li>Move calmly to assembly point</li>
                <li>Follow the instructions of emergency services and wardens.</li>
                <li>Wait for the OK to re-enter the building.</li>
              </ul>
              <ul className="list-disc list-inside p-4 space-y-1 leading-snug">
                <li>Move to the evacuation location and stay until cleared.</li>
                <li>Follow instructions from emergency personnel and wardens.</li>
              </ul>
            </div>

            {/* Headings */}
            <div className="grid grid-cols-1 md:grid-cols-2 border-b border-black bg-gray-200 font-semibold text-sm text-black">
              <div className="border-r border-black p-2">Medical Emergency</div>
              <div className="p-2">Civil Disturbance</div>
            </div>

            {/* Emergency Descriptions */}
            <div className="grid grid-cols-1 md:grid-cols-2 border-b border-black flex-grow">
              <div className="p-4 border-r border-black space-y-1 leading-snug">
                <p className="mb-1">Assess the situation:</p>
                <ul className="list-disc list-inside space-y-1">
                  <li>Do not move a participant unless in life-threatening danger.</li>
                  <li>Call 000 for ambulance, then ring supervisor.</li>
                  <li>Arrange for ambulance to be met at location.</li>
                  <li>Remain with the participant and provide first aid if needed.</li>
                  <li>Follow emergency services' instructions.</li>
                </ul>
              </div>
              <div className="p-4 space-y-1 leading-snug">
                <ul className="list-disc list-inside space-y-1">
                  <li>Keep away from disturbance. Don’t provoke irrational behavior.</li>
                  <li>Consider lockdown to prevent unauthorized access.</li>
                  <li>Follow instructions from emergency personnel and wardens.</li>
                  <li>Evacuate only if instructed.</li>
                </ul>
              </div>
            </div>
            ...
            {/* Headings */}
            <div className="grid grid-cols-1 md:grid-cols-2 border-b border-black bg-gray-200 font-semibold text-sm text-black">
              <div className="border-r border-black p-2">Extreme Weather</div>
              <div className="p-2">Personal Preparation</div>
            </div>

            {/* Extreme Weather and Personal Preparation */}
            <div className="grid grid-cols-1 md:grid-cols-2 flex-grow">
              <div className="p-4 border-r border-black space-y-1 leading-snug">
                <ul className="list-disc list-inside space-y-1">
                  <li>Keep participant informed.</li>
                  <li>Turn off electrical appliances.</li>
                  <li>Follow emergency services' instructions.</li>
                  <li>Evacuate only if instructed.</li>
                  <li>Stay in contact with supervisor.</li>
                </ul>
              </div>
              <div className="p-4 space-y-1 leading-snug">
                <ul className="list-disc list-inside space-y-1">
                  <li>Know your emergency exits.</li>
                  <li>Plan an escape route.</li>
                  <li>Identify a safe evacuation point.</li>
                  <li>Locate fire alarms and extinguishers.</li>
