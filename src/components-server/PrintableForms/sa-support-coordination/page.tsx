...
const SASupportCoordination = ({formKey, formData, settings, commonFieldsData, images} : any ) => {
  return (
    <div>
        <Page1 data={formData} settings={settings} commonFieldsData={commonFieldsData} images={images} />
        <Page2 data={formData} settings={settings} commonFieldsData={commonFieldsData} images={images}/>
        <Page3 data={formData} settings={settings} commonFieldsData={commonFieldsData} images={images}/>
        <Page4 settings={settings} commonFieldsData={commonFieldsData} images={images}/>
        <Page5 settings={settings} commonFieldsData={commonFieldsData} images={images}/>
        <Page6 settings={settings} commonFieldsData={commonFieldsData} images={images}/>
        <Page7 data={formData} settings={settings} commonFieldsData={commonFieldsData} images={images}/>
    </div>
  )
}
