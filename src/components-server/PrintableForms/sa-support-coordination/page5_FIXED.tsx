...
The Individual’s plan is expected to remain in effect during the period the services are provided; and will immediately notify <span className="text-red-600 font-semibold"  style={{color: 'red'}}>Infinity Supports WA</span> if the Individual’s Plan is replaced by a new plan or the Individual’s funding ceases.            </p>
            ...
            <p className="text-xs font-normal font-montserrat mb-4 leading-relaxed">
              If the Individual wishes to give <span className="text-red-600 font-semibold" style={{color: 'red'}}>Infinity Supports WA</span> feedback OR is not happy with the provision of supports and wishes to make a complaint, they can talk to Sharon Mays or Anand Sekar at 0493282661; Email: <a href="mailto:admin@infinitysupportswa.org" className="text-blue-600 underline" style={{color: 'blue'}}>admin@infinitysupportswa.org</a>.
            </p>
            <p className="text-xs font-normal font-montserrat mb-6 leading-relaxed">
If the Individual is not satisfied or does not want to talk to this person, the Individual can contact the National Disability Insurance Agency by calling 1800 800 110, visiting one of their offices in person, or visiting <a href="https://www.ndis.gov.au" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline" style={{color: 'blue'}}>www.ndis.gov.au</a> for further information. The Individual can contact Department of Communities, Disability Services on (08) 9426 9200, or visiting one of their offices, or visit <a href="https://www.disability.wa.gov.au" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline" style={{color: 'blue'}}>www.disability.wa.gov.au</a>            </p>
            <br /><br />
            {/* Emergency Section */}
