...
const MDT = ({formData, commonFieldsData, settings, images} : any ) => {
  return (
    <div>
        <Page1  schema={formSchema} data={formData} commonFieldsData={commonFieldsData} settings={settings} images = {images}/>
    </div>
  )
}
