...
const pdfFormRegistry: PDFFormComponent[] = [
  {
    ...
    name: 'Client Intake Form v2',
  },
  {
    formKey: 'client_intake_form_v1',
    component: ClientIntakeForm, // Alternative/older version
    name: 'Client Intake Form v1',
  },
  ...
  // },
  // {
  //   formKey: 'home_risk_assessment',
  //   component: HomeRiskAssessmentPDF,
  //   name: 'Home Risk Assessment Form',
  // },
];
