...
//   return (
//     <A4PageWrapper>
//       <div className="flex flex-col h-full px-6 pt-6 pb-4 text-sm font-sans text-black leading-7">
//         {/* Logo and Tagline */}
...
const Page2: React.FC<Page2Props> = ({ schema, formData, settings, images }) => {
  ...
  return (
    <A4PageWrapper>
      <div
        className="flex flex-col h-full w-full px-6 pt-[1mm] pb-[1mm] text-sm font-sans text-black leading-6 justify-between"
        style={{ height: '100%' }}
      >
        {/* Top Section */}
