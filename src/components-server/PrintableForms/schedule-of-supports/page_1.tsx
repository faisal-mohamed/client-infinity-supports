...
//     <A4PageWrapper>
//       <div
//         className="flex flex-col w-full h-full px-1 pt-[2mm] pb-[2mm] text-[10px] font-sans justify-between"
...
//           {/* Title */}
//           <div className="text-center font-semibold text-[11px] mb-0.5">
//             Schedule of Support for: {commonFieldsData?.name || "________________"}
//           </div>

//           {/* NDIS and Plan Dates */}
//           <div className="flex justify-between text-[9px] mb-0.5 px-1">
...
//         {/* Table */}
//         <div
//           className="flex-1 flex flex-col mt-1 overflow-hidden"
//           style={{
//             maxHeight: "180mm", // ensures footer fits
...
//         {/* Footer */}
//         <div className="mt-1 flex justify-between text-[9px] px-1 text-gray-600">
