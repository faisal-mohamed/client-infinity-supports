    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {(downloadingForms.size > 0 || isDownloadingAll) && (
                    <button
                      ...
                      className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-xl hover:from-red-700 hover:to-red-800 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105"
                    >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              {completedForms.length > 0 && allDownloaded && (
                <button
                  type="button"
                  onClick={onProceed}
                  className="px-6 py-3 bg-gradient-to-r from-green-600 to-green-600 text-white rounded-xl hover:from-green-700 hover:to-green-700 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105"
                >
      ...
      {showCloseConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-80 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full border border-gray-200 animate-modal-appear">
            <div className="p-6">
              ...
              <div className="flex gap-3 justify-end">
                <button
                  ...
                  className="px-6 py-3 text-gray-700 bg-white border-2 border-gray-300 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 font-semibold shadow-md hover:shadow-lg"
                >
                  Cancel
                </button>
                <button
